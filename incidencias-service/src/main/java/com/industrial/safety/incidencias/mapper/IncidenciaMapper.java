...
public interface IncidenciaMapper {
    ...
    @Mapping(target = "slaMinutos", ignore = true)
    @Mapping(target = "slaVencimiento", ignore = true)
    @Mapping(target = "slaCumplido", ignore = true)
    @Mapping(target = "demoraJustificacion", ignore = true)
